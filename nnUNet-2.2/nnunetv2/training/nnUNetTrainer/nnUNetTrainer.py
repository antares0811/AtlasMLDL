...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self._best_ema = None
        self._best_target_class_dice = None
        ### inference things
    ...
    def get_training_transforms(patch_size: Union[np.ndarray, Tuple[int]],
        ...
        tr_transforms.append(SpatialTransform(
            ...
            p_rot_per_axis=0.8,  # todo experiment with this
    ...
    def on_epoch_end(self):
        ...
        target_class_dice = self.logger.my_fantastic_logging['dice_per_class_or_region'][-1][-1]
        if self._best_target_class_dice is None or target_class_dice > self._best_target_class_dice:
            self._best_target_class_dice = target_class_dice
            self.print_to_log_file(f"New best Dice for target class Tumor: {np.round(self._best_target_class_dice, 4)}")
        ...
        if self.local_rank == 0:
            if not self.disable_checkpointing:
                ...
                checkpoint = {
                    ...
                    '_best_target_class_dice': self._best_target_class_dice,
